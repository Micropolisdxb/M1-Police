...
void Steering_RC(int RC_Readings, int Steering_SW)
{
  ...
  if ((RC_Readings > (STEERING_RC_Zero - 2)) && (RC_Readings < (STEERING_RC_Zero + 2)))
  {
    Serial.print("Zero");
  ...
  if ((RC_Readings >= STEERING_RC_Min) && (RC_Readings <= (STEERING_RC_Zero - 2)))
  {
    Serial.print("Left: ");
    if (Steering_SW == 1722)
    {
